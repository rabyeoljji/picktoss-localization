        ...
        <div className="grid grid-cols-1 md:grid-cols-[250px_1fr] gap-6">
          ...
          <div className="bg-gray-50 p-4 rounded">
            <div className="flex justify-between items-center mb-4">
              ...
              <button onClick={resetAllFilters} className="text-sm text-blue-500">
                초기화
              </button>
            </div>
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 mb-4">
              전체 {filteredProducts.length}개 상품 중 {paginatedProducts.length}개 표시 (페이지 {currentPage}/
              {totalPages})
            </p>
            ...
            {paginatedProducts.length === 0 && (
              <div className="py-12 text-center text-gray-500">
                ...
                <button onClick={resetAllFilters} className="mt-4 text-blue-500 underline">
                  모든 필터 초기화하기
                </button>
              </div>
            )}
                    ...
                    <div className="p-3">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex gap-1 text-xs">
                          ...
                          {!product.inStock && (
                            <span className="bg-red-100 text-red-600 px-1.5 py-0.5 rounded">품절</span>
                          )}
                        </div>
                      </div>
                    </div>
                        ...
                        return (
                          <button
                            ...
                            className={`px-3 py-1 rounded ${
                              currentPage === pageNum ? 'bg-blue-500 text-white' : 'text-blue-500'
                            }`}
                          >
                            {pageNum}
                          </button>
