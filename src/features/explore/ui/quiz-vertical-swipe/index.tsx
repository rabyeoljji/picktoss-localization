...
const QuizVerticalSwipe = () => {
  ...
  return (
    <div className="sticky top-[calc(env(--header-height-safe)+46px)] w-full h-[calc(100vh-184px)] p-[16px] pt-[48px] flex flex-col items-center gap-[10px] overflow-hidden">
      <Swiper
        direction="vertical"
        slidesPerView={1}
        spaceBetween={0.01}
