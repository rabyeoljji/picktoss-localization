...
// 일반적인 사용을 위한 오버로드
export function useQueryParam(path: string, key: string, initialValue: string): [string, (value: string) => void]

export function useQueryParam(path: string, key: string, initialValue: number): [number, (value: number) => void]

export function useQueryParam(path: string, key: string, initialValue: boolean): [boolean, (value: boolean) => void]
