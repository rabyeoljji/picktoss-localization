...
// Individual stories for each case

export const DefaultToast: StoryObj<typeof Toaster> = {
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
      <p style={{ margin: 0 }}>Default Toast</p>
      <Button onClick={() => toast("This is a default toast")}>Open Default Toast</Button>
    </div>
  ),
}

export const ToastWithActionButton: StoryObj<typeof Toaster> = {
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
      <p style={{ margin: 0 }}>Toast with Action Button</p>
      <Button
        onClick={() =>
          toast("This toast has an action button", {
            action: {
...
export const ToastWithCancelButton: StoryObj<typeof Toaster> = {
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
      <p style={{ margin: 0 }}>Toast with Cancel Button</p>
      <Button
        onClick={() =>
          toast("This toast has a cancel button", {
            cancel: {
...
export const ToastWithLongTitle: StoryObj<typeof Toaster> = {
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
      <p style={{ margin: 0 }}>Toast with Long Title</p>
      <Button
        onClick={() =>
          toast(
            "This is a very long toast message that should wrap nicely and display all of the content without breaking the layout. Enjoy reading the long message!",
