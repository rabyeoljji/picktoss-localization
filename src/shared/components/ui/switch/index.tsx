    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          ...
          [
            size === "md" &&
              "size-4 data-[state=checked]:translate-x-[2px] data-[state=unchecked]:translate-x-[18px]",
          ],
          [
            size === "sm" &&
              "size-3 data-[state=checked]:translate-x-[2px] data-[state=unchecked]:translate-x-[16px]",
          ],
        )}
      />
    </SwitchPrimitive.Root>
